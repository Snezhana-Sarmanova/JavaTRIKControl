...
public class I2cCommunicator{
	...
	private synchronized static native void send0(int[] data, int deviceFileDescriptor);
	private synchronized static native int read0(int[] data, int deviceFileDescriptor);
